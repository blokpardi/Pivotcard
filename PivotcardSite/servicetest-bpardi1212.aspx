...
<asp:Content ID="Content1" ContentPlaceHolderID="main" runat="server">
    <script>
        function login() {
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + 'DataService.svc/loginUser/jodad/foo/jodaddy/Joe',
       ...
       var un = PivotEncode('https://www.google.com/profiles/103196419386017633518');
        ...
        function savePivot() {
            $.ajax({
                ...
                url: baseUrl + 'DataService.svc/savePivot/' + 'foobar' + '/' + 'TW' + '/' + '3' + '/' + PivotEncode('http://test.com/foobar') + '/' + 'pl' + '/' + 'false',
                contentType: "application/json",
                dataType: "json",
                success: function (R) {
                    alert(R);
...
<div id="status"></div>
<input type="button" value="Login" onclick="login2('https://www.google.com/profiles/103196419386017633518', 'Google')" />
...
<input type="button" value="Get single pivot" onclick="getSinglePivot('foobar', '1')" />
