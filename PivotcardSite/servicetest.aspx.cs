...
namespace PivotcardSite
{
    public partial class servicetest : System.Web.UI.Page
    {
        ...
        {
            bool res = PivotCardService.UserData.addUserToDB("billtest", null, "tester", "testservice");
        ...
        protected void ckUser_Click(object sender, EventArgs e)
        {
            bool isthere = PivotCardService.UserData.checkUser("http://www.facebook.com/profile.php?id=1061163494");
            Response.Write(isthere.ToString());
        }
    }
}