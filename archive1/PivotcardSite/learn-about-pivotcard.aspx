<%@ Page Title="" Language="C#" MasterPageFile="~/PCM.Master" AutoEventWireup="true" CodeBehind="learn-about-pivotcard.aspx.cs" Inherits="PivotcardSite.learn_about_pivotcard" %>
...
<script type="text/javascript">
    ...
    <div class="glidecontent" >
        <div class="greyfield" style="float:left; width:890px; height:110px;"><div style="margin:10px 10px 10px 10px;">Most of us have lots of online "identities" we use <br />for work, personal life, and play.</div></div>
    ...
    <div class="glidecontent" >
        ...
        <div style="float:left"><img alt="Collage" src="images/collage_2.png" /></div><div class="greyfield" style="float:left; width:410px; height:350px;"><div style=" text-align:left;margin:100px 10px 10px 50px;">And business cards are<br />great, but not a "one<br />size fits all" solution.</div></div>
    </div>
    
    <div class="glidecontent" >
        <div class="greyfield" style="float:left; width:890px; height:110px;"><div style="margin:10px 10px 10px 10px;">Welcome to Pivotcard. Share the right digital<br />identity with the right people. It's simple and flexible.</div></div>
        ...
        <div class="greyfield" style="float:left; width:890px; height:75px;"></div>
    </div>
    ...
    <div class="glidecontent" >
            ...
            <div class="greyfield" style="float:left; width:890px; height:350px;">
